...
@register_model
def base_patch200_1600_8k_vocab(pretrained=False, **kwargs):  # 5M
...
@register_model
def large_patch200_1600_8k_vocab(pretrained=False, **kwargs):  # 50M
    if "num_classes" in kwargs:
        _ = kwargs.pop("num_classes")
    if 'vocab_size' in kwargs:
        vocab_size = kwargs['vocab_size']
...
@register_model
def huge_patch200_1600_8k_vocab(pretrained=False, **kwargs):  # 380M
    if "num_classes" in kwargs:
        _ = kwargs.pop("num_classes")
    if 'vocab_size' in kwargs:
        vocab_size = kwargs['vocab_size']
