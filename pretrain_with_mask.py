...
def get_args():
    parser = argparse.ArgumentParser('EEGfounder pre-training script', add_help=False)
    ...
    # Model parameters
    parser.add_argument('--model', default='base_patch200_1600_8k_vocab', type=str, metavar='MODEL',
...
def main(args):
    ...
    dataset_train_list, train_ch_names_list = utils.build_pretraining_dataset(datasets_train, time_window,
                                                                              stride_size=200*10, start_percentage=0,
                                                                              end_percentage=1)
